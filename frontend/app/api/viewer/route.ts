  ...
  try {
    ...
    if (!resourceType || !resourceId) {
      return NextResponse.json(
        { error: 'Missing resourceType or resourceId query parameters' },
        { status: 400 }
      )
    }
...
function createDemoResource(resourceType: string, resourceId: string) {
  ...
  if (resourceType === 'Composition') {
    return {
      ...
      text: {
        status: 'generated',
        div: '<div xmlns="http://www.w3.org/1999/xhtml"><h1>AI Generated Clinical Summary</h1><p>✅ Successfully created by Symphony AI workflow! This IPS-compliant FHIR Composition demonstrates the complete end-to-end functionality.</p></div>'
      },
      section: [
        {
  ...
  if (resourceType === 'DocumentReference') {
    return {
      ...
      text: {
        status: 'generated',
        div: '<div xmlns="http://www.w3.org/1999/xhtml"><h1>Clinical Summary Document</h1><p>✅ DocumentReference successfully created by Symphony AI workflow! This contains the complete clinical summary data.</p></div>'
      }
    }
  }

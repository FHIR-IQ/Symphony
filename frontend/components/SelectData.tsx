  ...
  const publicServers = [
    {
      ...
      url: process.env.NEXT_PUBLIC_HAPI_SERVER_URL ? `${process.env.NEXT_PUBLIC_HAPI_SERVER_URL}${process.env.NEXT_PUBLIC_HAPI_BASE_PATH || '/fhir'}` : 'https://symphony-hapi.railway.app/fhir',
